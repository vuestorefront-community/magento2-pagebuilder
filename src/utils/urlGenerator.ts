import { BrowserPersistence } from './dataPersistence';
...
let mediaBackend = storage.getItem('store_view_secure_base_media_url')
...
const joinUrls = (base, url) => `${base.endsWith('/') ? base.slice(0, -1) : base
}/${
